...
<template>
  <div class="grid grid-cols-12">
    ...
    <div class="col-span-full mt-10 mb-20">
      <div class="flex justify-center">
        <div class="w-4/6 text-center animate-section" :class="{ visible: sectionVisibility[0] }">
          <p>
    ...
    <div class="col-span-full flex items-center justify-center">
      <div class="grid w-full grid-cols-12">
        ...
        <div class="col-span-4 mt-10 animate-section" :class="{ visible: sectionVisibility[3] }">
          <div class="flex flex-col items-start">
            <div class="flex items-center gap-2">
              <svg class="size-12 fill-current opacity-15" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
                <path
        ...
        <div class="col-span-6"></div>
        <!-- AI-Driven Solutions -->
        <div class="col-span-4 mt-10 animate-section" :class="{ visible: sectionVisibility[4] }">
          <div class="mt-10 mb-20">
            <div class="flex flex-col items-start">
              <div class="flex items-center gap-2">
                <svg class=" size-12 opacity-15" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
                  <path

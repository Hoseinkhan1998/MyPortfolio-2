    ...
    <div class="col-span-full flex mt-20 justify-center ">
      <div class="grid grid-cols-12 gap-x-8 gap-y-5">
        ...
        <div
          ...
          class="lg:col-span-3 col-span-6 hover:!scale-110 transition-all duration-300 gap-4 flex flex-col justify-center items-center animate-section"
        ...
        <div
          ...
          <svg class="size-16" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
            <path
              fill="#F4511E"
